...
export const DEFAULT_SLIM_QUEUE_INITIAL_CAPACITY = 128;
export const DEFAULT_SLIM_QUEUE_CAPACITY_INCREMENT_FACTOR = 1.5;
...
export class SlimQueue<T> {
    ...
    private _calculateExclusiveTailIndex(): number {
